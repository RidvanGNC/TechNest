...
// Duman sensörü için kullanılacak analog pin
int dumanSensoruPin = A0;
...
void loop() {
  // Duman sensöründen okunan değeri al
  int dumanDegeri = analogRead(dumanSensoruPin);

  // Eğer duman algılandıysa
  if (dumanDegeri > 500) {
    // JSON verisi oluştur
    String jsonStr = "{\"dumanAlgildi\":true,\"dumanDegeri\":" + String(dumanDegeri) + "}";
